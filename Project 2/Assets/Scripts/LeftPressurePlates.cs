...
public class LeftPressurePlates : MonoBehaviour
{
    ...
    void FireArrow()
    {
        GameObject arrow = Instantiate(arrowPrefab, arrowSpawnPoint.position, arrowSpawnPoint.rotation * Quaternion.Euler(0, 0, 270)); // Fixes rotation
